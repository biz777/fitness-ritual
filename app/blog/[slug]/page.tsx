  ...
  return (
    <div style={{ background: "#F8F8FF", minHeight: "100vh" }}>
      ...
      <article style={{ maxWidth: "760px", margin: "0 auto", padding: "56px 32px" }}>
        <Link href="/blog" style={{ fontSize: "15px", color: "#1A1A2E", textDecoration: "none", display: "inline-block", marginBottom: "24px" }}>
          ← Back to blog
        </Link>
        ...
        <p style={{ fontSize: "18px", color: "#1A1A2E", lineHeight: 1.75, marginBottom: "12px" }}>
          {article.description}
        </p>
        <div style={{ fontSize: "14px", color: "#1A1A2E", marginBottom: "48px" }}>
        ...
        <div style={{
          ...
          fontFamily: "Arial, sans-serif", fontSize: "16px", color: "#1A1A2E",
        }}>
